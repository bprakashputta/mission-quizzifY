...
if __name__ == "__main__":
    ...
    embed_config = {
        ...
        "project": "gemini-quizzify-427417",
    ...
    if 'question_bank' not in st.session_state or len(st.session_state['question_bank']) == 0:
        ...
        with screen.container():
            ...
            with st.form("Load Data to Chroma"):
                ...
                topic_input = st.text_input("Topic for Generative Quiz", placeholder="Enter the topic for the quiz")
        ...
        with st.container():
            ...
            with st.form("MCQ"):
                ...
                next_question = st.form_submit_button("Next")
                if(next_question):
                    quiz_manager.next_question_index(1)

                previous_question = st.form_submit_button("Previous")
